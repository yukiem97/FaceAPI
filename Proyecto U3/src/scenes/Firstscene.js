...
class Firstscene extends Phaser.Scene{
    ...
    preload(){
        ...
        this.load.image('backgroud', 'backgrounds/background.png')
    ...
    create(){
        //Agregar los textos
        this.scoreText = this.add.text(this.sys.game.canvas.width / 2 - 65, 0, 'SCORE: ' + this.scoreText,
        ...
        this.ammoText = this.add.text(this.sys.game.canvas.width - 150, 10, 'AMMO: ' + this.ammo,
            { fontStyle: 'strong', align: 'rigth', font: '24px Arial', fill: 'beige' });
        ...
        this.background = this.add.image(this.sys.game.canvas.width / 2, this.sys.game.canvas.height / 2,
            'background');
        this.lifeSprite = this.add.image(30, 18, 'life').setDepth(1);
        this.soapImage = this.physics.add.image(40, this.sys.game.canvas.height - 30, 'soap')
            .setActive(true).setDepth(1).setVisible(false);
        ...
        this.physics.add.overlap(this.player, [this.virusGroup, this.bacteriumGroup, this.powerupGroup],
            this.hitPlayer, null, this);
        this.physics.add.collider(this.bulletGroup, [this.virusGroup, this.bacteriumGroup],
